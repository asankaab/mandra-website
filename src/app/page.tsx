...
export default async function Home() {
  ...
  <>
    <main className={styles.main}>
      <div className="wrapper">
        ...
        <div className={styles.colRight}>
          <Carousel className='reveal' imagesArray={homepageData.fields.heroImages} logo={homepageData.fields.brandLogo}/>
        </div>
      </div>
    </main>
    <section className={styles.section}>
      <div className="wrapper">
        <Animator animation={slideUp} target=".anim" autoplay="scroll">
          <MiniTitle className="anim">Showcase</MiniTitle>
          <Heading1 className="anim">Beautifully Capturing Human Memories.</Heading1>
          <div className={styles.cardContainer}>
              {showcaseData.items.map((projectEntry: ProjectEntrySkeleton) => {
                return (
                  <ProjectCard className="anim" entry={projectEntry} key={projectEntry.sys.id} />
                )
              })}
          </div>
        </Animator>          
    ...
    <section className={styles.section}>
      <div className="wrapper">
        <Animator animation={slideUp} autoplay="scroll">
          <MiniTitle className="anim">Our Style</MiniTitle>
          <Heading1 className="anim">Elegant, Timeless, and artistic Photography Style</Heading1>
          <div className={styles.serviceContainer} >
            {services.items.map((item: ServicesEntrySkeleton, key: number) => {
              return (
                <ServiceBox className="anim" key={item.sys.id} entry={item} number={key} />
              )
            })}
          </div>
        </Animator>
    ...
    <section className={styles.section}>
      <div className="wrapper">
        <Animator animation={slideUp} autoplay="scroll">
          <MiniTitle className="anim">Our Team</MiniTitle>
          <Heading1 className="anim">Your Story, Our Vision, Perfectly Captured.</Heading1>
          ...
          <Button className="anim" varient="outline" href="about">Read More About Us</Button>
        </Animator>
      </div>
    </section>
    <section className={styles.section}>
      <div className="wrapper">
        <Animator animation={slideUp} autoplay="scroll">
          <MiniTitle className="anim">Blog</MiniTitle>
          <Heading1 className="anim">Get Updated With Latest Content.</Heading1>
          <div className={styles.blogContainer}>
              {blogData.items.map((article: BlogEntrySkeleton)=> {
                return (
                  <BlogCard className="anim" entry={article} key={article.sys.id}/>
                )
              })}
          </div>
          <Button className="anim" varient="outline" href="blog">Read Our Blog</Button>
        </Animator>
      </div>
    </section>
    <section className={styles.section}>
      <div className="wrapper">
        <Animator animation={slideUp} autoplay="scroll">
          <div className={styles.formContainer}>
            <div className="anim">
              <Heading2 bold className="anim">Join the mailing list!</Heading2>
              <Paragraph className="anim">Sign up for our mailing list for occasional updates, seasonal offers, and special events!</Paragraph>
              <NewsletterForm/>
            </div>
